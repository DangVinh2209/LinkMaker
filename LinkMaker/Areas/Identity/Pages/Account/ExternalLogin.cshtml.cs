...
namespace LinkMaker.MVC.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        //    $"Please confirm your account by <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here</a>.");s
        ...
        private LinkMakerUser CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(LinkMakerUser)}'. " +
                    $"Ensure that '{nameof(LinkMakerUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
